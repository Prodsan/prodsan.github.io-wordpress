/* Plugin Tests 1.1.2 */
(function($){$(document).ready(function(){if('undefined'===typeof aalTests){console.log('Amazon Auto Links','The test script failed to load');return;}
...
var _aTestArguments=$('input.test-arguments').map(function(){return $(this).val();}).get();if(1===_aTestArguments.length&&''===_aTestArguments[0]){_aTestArguments=[];}
